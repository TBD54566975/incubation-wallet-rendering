...
(function (serverside, global, $, _, JSON) {
   ...
   */
  Tree.prototype.buildFromLayout = function (el, context) {
    ...
    if (el.key) {
      ...
      el.title = el.title || schemaElement.title;
      el.description = el.description || schemaElement.description;
    ...
    view = render.elementTypes[el.type];
    if (!view) {
      throw new Error(
